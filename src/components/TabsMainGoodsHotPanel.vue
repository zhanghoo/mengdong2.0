<template>
  <div class="goods-hot">
    <div class="shop-hot-top">
      <div class="shop-hot-bg" @click.stop="toGoodsTexts">
        <div>
          <p class="shop-hot-icon"><span class="icon icon-type"></span></p>
          <p class="shop-hot-title">{{hot.title}}</p>
          <p class="shop-hot-theme">[{{hot.theme}}]</p>
        </div>
      </div>
    </div>
